...
public abstract class PIPCalcProcessor extends Observable{
    ...
    public void printTrees(){
        System.out.println(this.tree.toPrefixString());
        System.out.println(this.tree.toInfixString());
        System.out.println(this.tree.toPostfixString());
    }
